...
// single-worktree case still lands at "AI分析师 Canary".
const DEV_APP_NAME = process.env.DESKTOP_APP_SUFFIX
  ? `AI分析师 Canary ${process.env.DESKTOP_APP_SUFFIX}`
  : "AI分析师 Canary";
...
if (is.dev) {
  ...
  // to "AI分析师", but anchoring it here makes WM_CLASS ↔ StartupWMClass
