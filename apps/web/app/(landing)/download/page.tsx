...
export const metadata: Metadata = {
  title: "Download AI分析师",
  description:
    "Download AI分析师 for macOS, Windows, or Linux — or install the CLI for servers and remote dev boxes.",
  openGraph: {
    title: "Download AI分析师",
    description:
      "Get the AI分析师 desktop app with a bundled daemon, or install the CLI for servers and remote dev boxes.",
    url: "/download",
  },
  alternates: {
    canonical: "/download",
