...
description: Install the AI分析师 CLI and start the agent daemon.
---
...
This configures the CLI for AI分析师 Cloud, opens your browser for login, discovers your workspaces, and starts the agent daemon.
