---
title: CLI Reference
description: Complete command reference for the AI分析师 CLI and agent daemon.
---
...
When connecting to a self-hosted AI分析师 instance, point the CLI to your server before logging in:
