/**
 * Multica architecture diagram for §1.2 "How AI分析师 Works".
 *
 ...
 * "AI分析师" (metadata store and coordinator).  The asymmetric sizes and the
      ...
      <div className="flex-1 space-y-5">
        ...
        <div>
          ...
          <div className="text-xs text-muted-foreground mb-2.5">
            Polls work from AI分析师. Invokes local AI coding tools:
          </div>
