...
// for the AI分析师 Agent to every commit made in the worktree.
...
// path: a bare cache that already carries the AI分析师 prepare-commit-msg hook
...
// sentinel — only the older `# Installed by the AI分析师 daemon.` comment.
